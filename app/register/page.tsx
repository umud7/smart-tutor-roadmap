...
import { Brain, User, Mail, Lock, Eye, EyeOff, GraduationCap } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Hesab yaradın və öyrənməyə başlayın</p>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Məlumatlarınızı daxil edərək hesab yaradın</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.userType} onValueChange={(value) => handleInputChange("userType", value)}>
                  <SelectTrigger>
                    <SelectValue placeholder="İstifadəçi tipini seçin" />
                  </SelectTrigger>
                  <SelectContent>
